...
// ЗАДАЧА 5
// Напишіть ф-цію calculateAverage() яка приймає довільну кількість аргументів і повертає 
// їх середнє значення .Всі аргументи будуть тільки числовими
...
// ЗАДАЧА 7
// Виконайте рефакторинг замінивши обявлення ф-ції з function declaration на function 
// expression та на стрілочну функцію
...
// removeCourse("HTML"); // ['HTML', 'CSS', 'JavaScript', 'PostgreSQL', 'Express']
// removeCourse("sfs"); 
// removeCourse("CSgdS");
// removeCourse("CSS");// 'Курс з таким іменем не найдено'
